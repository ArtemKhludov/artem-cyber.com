...
-- RLS политики для callback_requests (расширенные)
...
-- RLS политики для purchase_requests
...
-- RLS политики для general_requests
