      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="text-gray-700 mb-6 space-y-4">
            <p>
              <strong>1.1.</strong> Настоящее соглашение (далее — &laquo;Соглашение&raquo;) регулирует отношения между пользователем (далее — &laquo;Пользователь&raquo;) и владельцами платформы EnergyLogic (далее — &laquo;Администрация&raquo;).
            </p>
            <p>
