    ...
    <PageLayout>
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="text-gray-700 mb-6 space-y-4">
            <p>
              <strong>2.1.</strong> EnergyLogic предоставляет доступ к авторским материалам, PDF-файлам, онлайн-тестам, аналитике и результатам, сгенерированным с использованием интеллектуальных алгоритмов и языковых моделей (например, GPT от OpenAI).
            </p>
            <p>
